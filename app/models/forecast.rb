class Forecast
	...
	:fcttext9, :icon9, :day9, :fcttext10, :icon10, :day10, :location, :city, :y
	...
	def looping(response)
		a = response.parsed_response['response']['forecast']['simpleforecast']['forecastdays']['forecastday']
		a['date'].each do |day|
			 self.y = day['weekday']
